...
mkdir -p "./log/"
mkdir -p "./trace/"
mkdir -p "./output/simCFW/"

WORKMAIN="/nfs/scratch01/abaud/htonnele/nf_PRJs/nf-CoreQuantGen/simulations/"
mkdir -p "$WORKMAIN/work_CFW"

# define params file
PARFILE="params/params.simCFW.set0.yaml"
#PARFILE="params/params.simCFW.BAPBCr.yaml"
#PARFILE="params/params.simCFW.BIrHMP.yaml"
#PARFILE="params/params.simCFW.HLPBLL.yaml"
#PARFILE="params/params.simCFW.HLPHMP.yaml"
#PARFILE="params/params.simCFW.NKiyTS.yaml"
#PARFILE="params/params.simCFW.set0_sex.yaml"
#PARFILE="params/params.simCFW.SxHEp.yaml"
