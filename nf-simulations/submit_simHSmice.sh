...
mkdir -p "./log/"
mkdir -p "./trace/"
mkdir -p "./output/simHSmice/"

WORKMAIN="/nfs/scratch01/abaud/htonnele/nf_PRJs/nf-CoreQuantGen/simulations/"
mkdir -p "$WORKMAIN/work_HSmice"

# define params file
PARFILE="params/params.simHSmice.set0.yaml"
#PARFILE="params/params.simHSmice.set0_sex.yaml"
